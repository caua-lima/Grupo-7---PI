    ...
    <div class="flex-container">
      ...
      <div class="right-section">
        ...
        <div class="section">
          <table class="info-table">
            ...
            <tr>
              ...
              <td><?php echo htmlspecialchars($reposicaoInfo['situacao']); ?></td>
            </tr>
            ...
            <tr>
              ...
              <td><?php echo htmlspecialchars($reposicaoInfo['motivo_indeferimento']); ?></td>
            </tr>
            <?php endif; ?>
          </table>
        </div>
        ...
        <div id="agenda-completa" class="tabela">
          <fieldset>
            <legend>
              <h3>Agenda Completa do Professor</h3>
            </legend>
            <!-- Legenda das cores -->
