            ...
            <a class="link-column" href="faltas.php">
                <div class="first-column">
                        <ul class="list-window">
                            ...
                            <li class="desc-window"><p>FORMULÁRIO</p></li>
                            <li class="desc-window"><p>DE FALTAS</p></li>
                        </ul>
                </div>
            </a>
            <a class="link-column" href="reposicao.php">
                <div class="second-column">
                    <ul class="list-window">
                        <li class="item-window"><i class="fa-regular fa-calendar-days"></i></li>
                        <li class="desc-window"><p>REPOSIÇÃO</p></li>
                        <li class="desc-window"><p>DE AULAS</p></li>
                    </ul>
                </div>
            </a>
            <a class="link-column" href="professor.php">
                <div class="third-column">
                    <ul class="list-window">
                        ...
                        <li class="desc-window"><p>HISTÓRICO</p></li>
                    </ul>
                </div>
            </a>
        </div>
