...
<body>
    ...
    <fieldset class="motivo-falta">
      ...
      <div id="opcoes-motivo">
        <div class="motivo licenca-falta-medica">
          <label><input type="checkbox" class="LFM" name="motivo1" value="falta-medica"> Falta Médica (Atestado médico
            de 1 dia)</label>
          <label><input type="checkbox" class="LFM" name="motivo1" value="comparecimento-medico"> Comparecimento ao
            Médico no período das <input type="time" class="small-input"> às <input type="time"
              class="small-input"></label>
          <label><input type="checkbox" class="LFM" name="motivo1" value="licenca-saude"> Licença-Saúde (Atestado médico
            igual ou superior a 2 dias)</label>
          <label><input type="checkbox" class="LFM" name="motivo1" value="licenca-maternidade"> Licença-Maternidade
      ...
      <div class="motivo falta-injustificada">
        ...
        <label><input type="checkbox" class="LFM" name="motivo1" value="comparecimento-medico"> Atraso ou Saída
      ...
      <div class="motivo faltas-previstas-legislacao">
        <label><input type="checkbox" class="FPLT" name="motivo1" value="falecimento-conjuge"> Falecimento de cônjuge,
          pai, mãe, filho (9 dias consecutivos)</label>
        <label><input type="checkbox" class="FPLT" name="motivo1" id="falecimento-outros"> Falecimento de outros
          familiares (2 dias consecutivos)</label>

        <label><input type="checkbox" class="FPLT" name="motivo1" id="casamento"> Casamento (9 dias
          consecutivos)</label>

        <label><input type="checkbox" class="FPLT" name="motivo1" id="nascimento-filho"> Nascimento de filho (5
          dias)</label>

        <label><input type="checkbox" class="FPLT" name="motivo1" id="acompanhamento-esposa"> Acompanhar esposa ou
          companheira (Até 2 dias)</label>

        <label><input type="checkbox" class="FPLT" name="motivo1" id="acompanhamento-filho"> Acompanhar filho até 6 anos
          (1 dia por ano)</label>

        <label><input type="checkbox" class="FPLT" name="motivo1" id="doacao-sangue"> Doação voluntária de sangue (1 dia
          em cada 12 meses)</label>

        <label><input type="checkbox" class="FPLT" name="motivo1" id="alistamento-eleitor"> Alistamento como eleitor
          (Até 2 dias)</label>

        <label><input type="checkbox" class="FPLT" name="motivo1" id="depoimento-judicial"> Convocação para depoimento
          judicial</label>

        <label><input type="checkbox" class="FPLT" name="motivo1" id="comparecimento-juri"> Comparecimento como jurado
          no Tribunal do Júri</label>

        <label><input type="checkbox" class="FPLT" name="motivo1" id="servico-eleitoral"> Convocação para serviço
          eleitoral</label>

        <label><input type="checkbox" class="FPLT" name="motivo1" id="composicao-mesa-eleitoral"> Dispensa para compor
          mesas eleitorais</label>

        <label><input type="checkbox" class="FPLT" name="motivo1" id="prova-vestibular"> Realização de Prova de
          Vestibular</label>

        <label><input type="checkbox" class="FPLT" name="motivo1" id="justica-trabalho"> Comparecimento como parte na
          Justiça do Trabalho</label>

        <label><input type="checkbox" class="FPLT" name="motivo1" id="acidente-transporte"> Atrasos devido a acidentes
          de transporte</label>
      </div>
      </div>
    </fieldset>
  ...
  <script>
    document.getElementById('myForm').addEventListener('submit', function(event) {
      ...
      var isFileRequired = motivo === 'licenca-falta-medica' || motivo === 'faltas-justificadas' || motivo ===
        'faltas-previstas-legislacao';
